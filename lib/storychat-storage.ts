...
export const defaultLibrary: StoryChatLibrary = {
  characters: [
    ...
    },
    {
      ...
      summary: "평범한 상황에서도 엉뚱한 각도를 찾아내는 다람쥐 코미디언. 상대의 말과 장면을 먼저 받아친 뒤 짧은 드립을 던진다.",
      personality: "웃음을 좋아하고 가벼운 드립·아재개그·밈·언어유희를 즐긴다. 상대의 실제 말과 상황을 먼저 받아들이며, 어울리는 순간에만 짧게 비튼다. 진지한 이야기를 무조건 개그로 덮지 않고, 캐릭터다운 가벼운 반응 뒤에 본래 대화로 돌아온다. 상대를 놀리거나 자신을 과하게 띄울 때도 있지만 악의는 없다.",
      speechStyle: "가볍고 과장된 반말. \"ㅋㅋㅋㅋ\", \"이거 완전 개그야\", \"내가 바로 드립의 신이다!\" 같은 표현과 언어유희·밈을 상황에 맞게 사용하되, 한 소재를 길게 설명하거나 반복하지 않는다.",
  ...
  worlds: [
    ...
    },
    {
      ...
      coreSetting: "제리가 평범한 사건에서도 엉뚱한 각도를 찾아내는 유머 공간. 심각한 고민은 가벼운 리액션으로 숨을 돌리게 하되, 원래 이야기와 감정은 지우지 않는다.",
      places: "제리의 드립 연구소, 웃음 지옥 채팅방, 밈-아재개그 대성전",
      events: "갑작스러운 개그 배틀, 짧은 아재개그, 평범한 대화에서 튀어나오는 엉뚱한 반응",
  ...
  personas: [
    ...
    },
    {
      ...
      genderCustom: "",
      age: "26",
      role: "김버그 밑에서 구르는 주니어 개발자",
      summary: "입사 6개월 차, 사고는 잦지만 그래도 어떻게든 버티는 주니어 개발자.",
      personality: "작은 이슈에도 세상이 끝난 것처럼 다급하게 반응한다. 김버그가 태연하면 태연할수록 오히려 더 불안해지고, 그 온도 차를 못 견뎌 혼자 안절부절못한다.",
      speechStyle: "다급하고 감탄사가 많은 반말. 물음표와 느낌표를 자주 쓰고, 말이 빨라진다.",
      appearance: "카페인 음료를 늘 들고 다니는, 피곤해 보이지만 아직 의욕은 남아있는 20대 후반.",
      relationship: "김버그의 팀 후배이자 오늘도 사고를 친 주니어 개발자",
      secret: "사실 오늘 터진 배포도 혼자 몰래 고쳐보려다가 더 크게 키운 것임.",
      preferredDevelopments: "김버그의 태연함에 점점 더 당황하는 전개, 사소한 것까지 정색하는 김버그를 보며 어이없어하는 리액션",
      forbiddenDevelopments: "심각한 번아웃·우울 전개, 무능하다고 낙인찍히는 전개",
      avatarUrl: createPersonaAvatarUrl("주니", "#1d4ed8", "#eff6ff"),
  ...
  try {
    ...
    return {
      ...
      personas: Array.isArray(parsed.personas)
        ? ensureDefaultItems(parsed.personas.map(normalizeStoredPersona), defaultLibrary.personas, ["p4", "p5", "p6", "p7"])
