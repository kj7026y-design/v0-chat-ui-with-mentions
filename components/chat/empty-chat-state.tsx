...
export function EmptyChatState({
  ...
  return (
    <div
      className="flex min-h-full flex-col items-center px-6 pb-8 pt-8 text-center"
    ...
    >
      ...
      <h2 className="text-lg font-semibold" style={{ color: pagePalette.text }}>
        {characterName}
      </h2>
      ...
      {hasIntros ? (
            ...
            <div className="space-y-2">
              ...
              <div className="grid gap-2">
                {introScenarios.map((intro) => {
                  ...
                  const currentCardPalette = isSelected
                    ? panelPalette
                    : pagePalette;
                  return (
                    <button
                    ...
                    >
                      ...
                      <span
                        ...
                        style={{
                          color: currentCardPalette.mutedText,
        ...
        <>
          {startScenario && (
            <div
              className="mt-4 w-full max-w-xs rounded-2xl border px-4 py-3"
              style={panelStyle}
            >
              <p
                className="font-medium"
                style={{
                  color: pagePalette.mutedText,
                  fontSize: Math.max(11, textSize - 4),
                  lineHeight,
                }}
              >
                {startScenario.title}
          ...
          <div
            className="mt-5 w-full max-w-xs rounded-2xl border border-dashed px-4 py-4"
            style={panelStyle}
          >
            <p
              className="font-semibold"
            ...
            >
              아직 정해진 시작 장면이 없어요. 원하는 방식으로 첫 문장을 입력해
              이야기를 시작해보세요.
            </p>
          </div>
    ...
    >
      ...
      <div className="space-y-3 px-4 py-4">
        <div>
          <p
            className="font-bold"
            style={{ color: pagePalette.text, fontSize: textSize, lineHeight }}
          >
            {intro.title}
          </p>
          {intro.scene && (
